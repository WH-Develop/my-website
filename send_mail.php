<?php
//send_email.php
$email_from = "info@wh-develop.de";   //Absender falls keiner angegeben wurde
$sendermail_antwort = true;      //E-Mail Adresse des Besuchers als Absender. false= Nein ; true = Ja
$name_von_emailfeld = "Email";   //Feld in der die Absenderadresse steht

$empfaenger = "info@wh-develop.de"; //Empfänger-Adresse
$mail_cc = ""; //CC-Adresse, diese E-Mail-Adresse bekommt einer weitere Kopie
$betreff = "Neue Kontaktanfrage"; //Betreff der Email

$url_ok = "http://www.wh-develop.de/ok.htm"; //Zielseite, wenn E-Mail erfolgreich versendet wurde
$url_fehler = "http://www.wh-develop.de/fehler.htm"; //Zielseite, wenn E-Mail nicht gesendet werden konnte
